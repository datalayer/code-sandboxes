...
|-----------|------|-------------|
| `variant` | `str` | Sandbox type: `"eval"`, `"docker"`, `"jupyter"`, `"monty"`, `"kaggle"`, `"colab"`, `"modal"`, or `"datalayer"`. Defaults to `"datalayer"`. |
...
```python
@classmethod
def from_id(sandbox_id: str, variant: str = "datalayer") -> Sandbox
```
...
```python
@classmethod
def list(variant: str = "datalayer") -> list[SandboxInfo]
```
...
| Parameter | Type | Description |
|-----------|------|-------------|
| `variant` | `str` | Sandbox type: `"eval"`, `"docker"`, `"jupyter"`, `"monty"`, `"kaggle"`, `"colab"`, `"modal"`, or `"datalayer"` |
...
- `ColabKernelClient` connects to an already-running Google Colab kernel.
- The parser helpers extract connection details from browser channels URLs.

See [Kaggle](/sandboxes/kaggle) and [Google Colab](/sandboxes/google-colab) for
