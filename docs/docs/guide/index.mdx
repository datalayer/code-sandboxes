...
rest: what Code Sandboxes actually gives you over calling a backend's own SDK,
what each backend still decides for you, and how to choose between them.
...
| [`datalayer`](/providers/datalayer) | a Datalayer runtime | a kernel | yes | `gpu=` | create, list, get, update, delete |
