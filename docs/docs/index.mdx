...
**Not Responsible For:**
- ❌ MCP tool discovery or binding generation (→ mcp-codemode)
...
Code Sandboxes is used by mcp-codemode to execute tool composition code:

```python
from code_sandboxes import Sandbox
from mcp_codemode import CodeModeExecutor, ToolRegistry

# mcp-codemode uses code-sandboxes internally
