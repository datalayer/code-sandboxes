...
- **⚡ Multiple Backends**: eval, Docker containers, Jupyter kernels, or cloud runtimes
...
| Variant | Isolation Level | Best For |
|---------|-----------------|----------|
| `kaggle` | Kaggle notebook runtime | hosted interactive and batch execution |
| `colab` | Google Colab runtime | hosted interactive execution |
| `modal` | Cloud container | isolated, ephemeral cloud execution |
