...
Code Sandboxes provides a unified API across all supported variants (`eval`, `monty`, `docker`, `jupyter`, `kaggle`, `colab`, `modal`, `datalayer`), with native Jupyter kernel support.
