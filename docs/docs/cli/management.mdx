...
# ['datalayer', 'docker', 'eval', 'google_colab', 'jupyter', 'kaggle', 'modal', 'monty']
...
```python
get_manager("jupyter", server_url="http://localhost:8888", token="...")
get_manager("google_colab", server_url="https://...", proxy_token="...")
...
| `jupyter` | a kernel of the Jupyter Server | — nothing in place | the kernel |
| `google_colab` | a kernel of the Colab runtime | — nothing in place | the kernel |
