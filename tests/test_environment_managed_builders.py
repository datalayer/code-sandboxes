...
class TestTheHalfThatIsNotBuiltYet:
    @pytest.mark.parametrize("variant,item", [("e2b", "E2-03"), ("daytona", "E2-04")])
    def test_a_build_refuses_by_naming_what_is_missing(self, variant: str, item: str) -> None:
        ...
        Modal is built now (E2-05), covered by its own
        test_environment_modal_builder.py, so it is not one of these two."""
    ...
    @pytest.mark.parametrize("variant", ["e2b", "daytona"])
